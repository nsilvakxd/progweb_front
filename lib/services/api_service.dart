...
// --- NOVA IMPORTAÇÃO ---
import 'vakinha_api_service.dart';
...
class ApiService {
  ...
  // --- NOVOS MÉTODOS PARA VAKINHA ---
  Future<List<Vakinha>> getOpenVakinhas() => 
      _vakinhaApiService.getOpenVakinhas();

  Future<Vakinha> getVakinhaDetails(int id) => 
      _vakinhaApiService.getVakinhaDetails(id);

  Future<Vakinha> createVakinha(VakinhaCreate vakinha) =>
      _vakinhaApiService.createVakinha(vakinha);

  Future<Vakinha> closeVakinha(int id, VakinhaClose closeData) =>
      _vakinhaApiService.closeVakinha(id, closeData);

  Future<Contribution> addContribution(int vakinhaId, ContributionCreate contribution) =>
      _vakinhaApiService.addContribution(vakinhaId, contribution);
